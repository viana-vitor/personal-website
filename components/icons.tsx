export function Logo() {
  return (
    <svg width='39' height='48' className='stroke-black dark:stroke-white'>
      <path d='M38 .9v.464c-2.226-.041-2.984.441-3.645 2.015L23.292 33.752h-2.75S11.16 5.392 10.344 3.472c-.817-1.92-1.311-2.077-4.7-2.108V.93H17.12v.496h-3.613c-2.59.062-2.59 1.58-2.302 2.573.288.991 8.377 25.724 8.377 25.724h.096l8.377-24.64c.776-2.316.704-3.719-1.598-3.719H24.25V.9H38Z' />
      <path d='M.643 14.455v.465c2.226-.041 2.984.441 3.645 2.015l11.063 30.373h2.75s9.383-28.361 10.2-30.28c.816-1.92 1.31-2.077 4.7-2.108v-.434H21.52v.496h3.614c2.59.062 2.59 1.58 2.302 2.572-.288.992-8.377 25.725-8.377 25.725h-.096l-8.377-24.64c-.776-2.316-.704-3.719 1.598-3.719h2.207v-.465H.643Z' />
    </svg>
  )
}
