export function VVLogo() {
  return (
    ...
    >
      <path
        d="M532 13V19.7217C500.832 19.127 490.219 26.1008 480.97 48.8491L326.091 488H287.595C287.595 488 156.234 77.9453 144.801 50.1934C133.369 22.4415 126.449 20.1698 79 19.7217V13.4481H239.699V20.6179H189.117C152.859 21.5142 152.859 43.4717 156.887 57.8113C160.916 72.1509 274.166 429.745 274.166 429.745H275.509L392.788 73.4953C403.644 40.0065 402.635 19.7217 370.406 19.7217H339.52V13H532Z"
        fill="black"
        stroke="black"
      ...
      />
      <path
        d="M9 209V215.722C40.1677 215.127 50.7807 222.101 60.0296 244.849L214.909 684H253.405C253.405 684 384.766 273.945 396.199 246.193C407.631 218.442 414.551 216.17 462 215.722V209.448H301.301V216.618H351.883C388.141 217.514 388.141 239.472 384.113 253.811C380.084 268.151 266.834 625.745 266.834 625.745H265.491L148.212 269.495C137.356 236.006 138.365 215.722 170.594 215.722H201.48V209H9Z"
        fill="black"
        stroke="black"
        stroke-miterlimit="16"
        stroke-linecap="round"
