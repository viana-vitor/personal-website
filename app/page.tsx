    ...
    <section>
      <div className='flex flex-col md:flex-row items-start'>
        ...
        <div className='mt-8 md:mt-0 md:ml-6 space-y-2 text-neutral-500 dark:text-neutral-400'>
          <div>
            <h1 className='font-bold text-3xl font-serif text-black'>
              Vitor Viana
            </h1>
            <p className='my-5 max-w-[460px] text-neutral-800 dark:text-neutral-200'>
              Hi I'm Vitor, a freelance developer and start up founder.
            </p>
            <blockquote className='border-l-2 pl-6 italic my-5 max-w-[460px] text-neutral-500 dark:text-neutral-200'>
